...
$query = $conn->query("SELECT * FROM doctors_schedule where doctor_id=" . $_GET['id']);
?>
...
<script>
    $('#edit').click(function () {
        my_modal("Edit " + $('#my_modal .modal-title').html(), 'manage_doctor_schedule.php?did=<?php echo $_GET['id'] ?>', 'mid-large');
    });
</script>